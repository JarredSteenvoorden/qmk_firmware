...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LW] = LAYOUT_33_big_space(
    ...
    KC_F12 , KC_GRV , KC_EQL , KC_MINS, KC_F10 , KC_F11 , KC_SCLN, KC_BSLS, KC_LBRC, KC_RBRC,
    KC_LSFT, KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_RSFT,
  ...
  [_NV] = LAYOUT_33_big_space(
    ...
    _______, _______, CTL_TAB, ALT_TAB, _______, _______, KC_PGUP, KC_PGDN, _______, _______,
